...
This project simulates 1,000,000 returns using a GARCH(1,1) volatility model and
estimates downside risk through Value at Risk (VaR) and Expected Shortfall (ES).
...
- CSV file containing simulated returns
